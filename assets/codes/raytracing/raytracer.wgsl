...
fn main(@builtin(global_invocation_id) globalId: vec3<u32>)
{
    ...
    
    {
        ...
        textureStore(output, vec2<i32>(globalId.x, u32(resolution.y) - 1 - globalId.y), vec4<f32>(clamp((rayDirection.x + 1.0f) * 0.5f, 0.0f, 1.0f), clamp((rayDirection.y + 1.0f) * 0.5f, 0.0f, 1.0f), 0.0f, 1.0));
