...
**안정 상태 가설steady-state hypothesis**
...
**먹이 사슬 단계food-chain level**

**제한 구역confinement regions**

## 3.2. 자원 접근 그래프 개념

**자원 접근 그래프Resource Access Graph** (RAG)
...
**모집단 단위population unit**

**소비 자원consumed resource**

**시간적 변화temporal variation**

**적응도 범위fitness range**

**제한 영역confinement region**
