...
categories: graphics
lang: "ko"
description: "요즘에 GPU로 광선 추적을 가속화할 수 있긴 하지만, 그래도 실시간으론 겨우 몇 개의 광선 밖에 추적을 못 함. 그렇기 때문에 디노이저가 아무리 좋아도 문제가 발생할 수 밖에 없음. 최근 ReSTIR 알고리듬이 잘 되긴 하는데, 간접광 전용 알고리듬도 필요함."
status: "notes"
difficulty: "advanced"
series: "restir"
series_order: 5
...
{% include image.html src="/assets/images/ReStirGi/Figure2.jpeg" alt="Figure2" caption="Figure2" %}
...
{% include image.html src="/assets/images/ReStirGi/Figure4.jpeg" alt="Figure4" caption="Figure4" %}
...
{% include image.html src="/assets/images/ReStirGi/Figure6.jpeg" alt="Figure6" caption="Figure6" %}
...
{% include image.html src="/assets/images/ReStirGi/Figure10.jpeg" alt="Figure10" caption="Figure10" %}
