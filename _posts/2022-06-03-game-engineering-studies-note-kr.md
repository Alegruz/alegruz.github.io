...
![VectorDivision](/assets/images/GameEngineering/VectorDivision.png)

이때 **v'**를 또다른 벡터 **b**에 대해서도 회전을 해주면 **v''**를 구할 수 있음.

![Rotor](/assets/images/GameEngineering/Rotor.png)
...
![Complement](/assets/images/GameEngineering/Complement.png)
...
![AngularVelocityFigure](/assets/images/GameEngineering/AngularVelocityFigure.png)
...
![AngularVelocityEquation](/assets/images/GameEngineering/AngularVelocityEquation.png)

각속도는 보통 회전축 **A**에 평행하면서 크기가 \|ω(t)\|인 벡터로 표기함. 즉 각속도 벡터 **ω***(t)는 다음과 같음:

![AngularVelocityVectorEquation](/assets/images/GameEngineering/AngularVelocityVectorEquation.png)
...
![LinearVelocityFigure](/assets/images/GameEngineering/LinearVelocityFigure.png)
...
![DifferentialsOfYi](/assets/images/GameEngineering/DifferentialsOfYi.png)

위의 식을 벡터에 대해서 표현할 수 있음:

![VectorDifferentialsOfY](/assets/images/GameEngineering/VectorDifferentialsOfY.png)

이때 이 X에 대한 F의 편미분으로 구성된 행렬을 야코비라 부르며, 현재 x<sub>i</sub> 값들에 대한 함수라고 보면 됨. 마치 X의 속도를 정의역으로, Y의 속도를 치역으로 갖는 함수라고 생각하면 됨:

![JacobianMapping](/assets/images/GameEngineering/JacobianMapping.png)
...
![EndEffectorY](/assets/images/GameEngineering/EndEffectorY.png)
...
![AngularLinearVelocities](/assets/images/GameEngineering/AngularLinearVelocities.png)
...
![PlanarThreeJointManipulator](/assets/images/GameEngineering/PlanarThreeJointManipulator.png)
...
![ChangesInPosition](/assets/images/GameEngineering/ChangesInPosition.png)

end effector에 가할 목표 변화량은 end effector의 현재 위치와 목표 위치 간의 차임 (선형 변화량. 선형 속도):

![DesiredChange](/assets/images/GameEngineering/DesiredChange.png)
...
![JointAngleChangesJacobian](/assets/images/GameEngineering/JointAngleChangesJacobian.png)

### 야코비 역행렬

야코비를 이제 구했으면 

![JointAngleVelocities](/assets/images/GameEngineering/JointAngleVelocities.png)

이 식을 해결해야함. 만약 J가 사각행렬이라면 역행렬 J<sup>-1</sub>을 구해서 end effector의 속도가 주어졌을 때 각 관절의 각속도를 구할 수 있음. 

![JacobianInverse](/assets/images/GameEngineering/JacobianInverse.png)
...
![SingularConfiguation](/assets/images/GameEngineering/SingularConfiguation.png)
...
![PseudoInverse](/assets/images/GameEngineering/PseudoInverse.png)
...
![PseudoInverseMapping](/assets/images/GameEngineering/PseudoInverseMapping.png)

이제 위의 식에서 약간의 수정을 해준 다음, LU 분해를 통해 β에 대한 아래 방정식을 풀 수 있게 됨:

![LUDecomposedPseudoInverse](/assets/images/GameEngineering/LUDecomposedPseudoInverse.png)

이걸 이제 아래 식으로 수정해서 ![AngularVelocity](/assets/images/GameEngineering/AngularVelocity.png)를 구할 수 있음:

![SubstitutedVelocities](/assets/images/GameEngineering/SubstitutedVelocities.png)
...
![IK2dExample](/assets/images/GameEngineering/IK2dExample.png)
...
![DampedLeastSquaresApproach](/assets/images/GameEngineering/DampedLeastSquaresApproach.png)
...
![PseudoInverseVsDampedLeastSquares](/assets/images/GameEngineering/PseudoInverseVsDampedLeastSquares.png)
...
![NewtonRaphsonTaylorSeries](/assets/images/GameEngineering/NewtonRaphsonTaylorSeries.png)
...
![NewtonRaphsonTaylorSeriesSecondOrder](/assets/images/GameEngineering/NewtonRaphsonTaylorSeriesSecondOrder.png)
...
![NewtonRaphsonSingleValueUpdate](/assets/images/GameEngineering/NewtonRaphsonSingleValueUpdate.png)

이렇게만 했을 것임.

하지만 이제는 다변수 함수이므로:

![NewtonRaphsonMultivariateUpdate](/assets/images/GameEngineering/NewtonRaphsonMultivariateUpdate.png)
...
![QuasiNewtonCondition0](/assets/images/GameEngineering/QuasiNewtonCondition0.png)

위의 식을 행렬식으로 다시 작성하면:

![QuasiNewtonCondition1](/assets/images/GameEngineering/QuasiNewtonCondition1.png)

이제 기울기가 0인 지점을 구해야하니, ![GradientIsZero](/assets/images/GameEngineering/GradientIsZero.png)를 만족해야함. 즉, 

![DeltaTheta](/assets/images/GameEngineering/DeltaTheta.png)
...
![BFGSUpdate](/assets/images/GameEngineering/BFGSUpdate.png)

역행렬은 다음과 같이 업데이트 가능:

![BFGSInverseUpdate](/assets/images/GameEngineering/BFGSInverseUpdate.png)
...
![BFGSInverseUpdateRewritten](/assets/images/GameEngineering/BFGSInverseUpdateRewritten.png)
...
![FiniteDifferencing](/assets/images/GameEngineering/FiniteDifferencing.png)

이걸 다르게 재작성하면:

![FiniteDifferencingSecantMethod](/assets/images/GameEngineering/FiniteDifferencingSecantMethod.png)
...
![CCDFigure](/assets/images/GameEngineering/CCDFigure.png)
...
![CCDAngleFigure](/assets/images/GameEngineering/CCDAngleFigure.png)
...
![TriangulationIKFigure](/assets/images/GameEngineering/TriangulationIKFigure.png)
...
![FABRIKFigure0](/assets/images/GameEngineering/FABRIKFigure0.png)

![FABRIKFigure1](/assets/images/GameEngineering/FABRIKFigure1.png)

![FABRIKFigure2](/assets/images/GameEngineering/FABRIKFigure2.png)
...
![FABRIKJointRestriction](/assets/images/GameEngineering/FABRIKJointRestriction.png)
...
![FABRIKEllipsoidalShape](/assets/images/GameEngineering/FABRIKEllipsoidalShape.png)
...
![FABRIKEllipsoidalShapeFigure0](/assets/images/GameEngineering/FABRIKEllipsoidalShapeFigure0.png)
