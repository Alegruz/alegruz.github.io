...
lang: "ko"
description: "지형에 식물상과 동물상을 서로의 상호작용까지 고려하여 저작하는 새로운 방법을 소개하는 논문. 이 논문에서 소개하는 알고리듬을 통해 각 종별 밀도 맵, 일상 루틴으로 이루어진 안정된 상태의 생태계를 만들어줄 수 있으며, 지형의 침식, 기후적 조건, 생물학적 정보를 갖는 종들로부터 수..."
status: "notes"
...
{% include image.html src="/assets/images/AuthoringConsistentLandscapesWithFloraAndFauna/Figure1.png" alt="Figure1" caption="Figure1" %}
...
{% include image.html src="/assets/images/AuthoringConsistentLandscapesWithFloraAndFauna/FitnessScore.png" alt="FitnessScore" caption="FitnessScore" %}
