...
categories: graphics
lang: "ko"
description: "이 노트는 NVIDIA에서 제공한 광선 추적법 입문 시리즈인 Ray Tracing Essentials를 한국어로 정리/요약한 노트입니다. 광선 추적법을 공부하시는 분들을 위해 남깁니다."
status: "notes"
difficulty: "advanced"
topic: rendering
...
{% include image.html src="/assets/images/RayTracingEssentials/Ray.jpeg" alt="Ray" caption="Ray" %}

**광선Ray**이란 어떠한 원점origin과 방향direction을 갖는 것이다.

{% include image.html src="/assets/images/RayTracingEssentials/RayCasting.jpeg" alt="RayCasting" caption="RayCasting" %}

**광선 투사법Ray Casting**이란 이러한 광선을 정해진 방향으로 쏘아 어떤 물체와 충돌하게 만드는 것이다.

{% include image.html src="/assets/images/RayTracingEssentials/RayCastingBetweenTwoPoints.jpeg" alt="RayCastingBetweenTwoPoints" caption="RayCastingBetweenTwoPoints" %}

광선 투사법은 두 점에 대해서도 사용해주어 두 점 사이에 무언가가 가로막고 있는지 확인해줄 수 있다.

{% include image.html src="/assets/images/RayTracingEssentials/RayCastingBetweenTwoSurfaces.jpeg" alt="RayCastingBetweenTwoSurfaces" caption="RayCastingBetweenTwoSurfaces" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/ClassicalRayTracing.jpeg" alt="ClassicalRayTracing" caption="ClassicalRayTracing" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/StochasticRayTracing.jpeg" alt="StochasticRayTracing" caption="StochasticRayTracing" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/KajiyaStyleDiffuseInterreflection.jpeg" alt="KajiyaStyleDiffuseInterreflection" caption="KajiyaStyleDiffuseInterreflection" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/Rasterization0.jpeg" alt="Rasterization0" caption="Rasterization0" %}

위처럼 화면에 세 개의 삼각형이 있다고 가정하자.

{% include image.html src="/assets/images/RayTracingEssentials/Rasterization1.jpeg" alt="Rasterization1" caption="Rasterization1" %}

첫번째로 빨간색 삼각형을 래스터화하면 위와 같이 픽셀에 색을 할당해줄 수 있다.

{% include image.html src="/assets/images/RayTracingEssentials/Rasterization2.jpeg" alt="Rasterization2" caption="Rasterization2" %}

두번째로 초록색 삼각형을 래스터화하면 위와 같이 픽셀에 색을 할당해줄 수 있다. 초록색 삼각형은 빨간색 삼각형보다 앞에 있으니 겹치는 픽셀의 경우 빨간색 위에 초록색이 덧씌워졌다.

{% include image.html src="/assets/images/RayTracingEssentials/Rasterization3.jpeg" alt="Rasterization3" caption="Rasterization3" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/RayTracing.gif" alt="RayTracing" caption="RayTracing" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/BoundingVolumeHierarchy.jpeg" alt="BoundingVolumeHierarchy" caption="BoundingVolumeHierarchy" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/BoundingBox.jpeg" alt="BoundingBox" caption="BoundingBox" %}

실제 광선 추적법의 경우 위의 사진과 같이 경계 박스를 사용한다. 결국 박스를 계속 타고 내려가서 결과적으로 어떤 삼각형과 교차하는지, 충돌하는지를 확인한다.

{% include image.html src="/assets/images/RayTracingEssentials/FakeNews.png" alt="FakeNews" caption="FakeNews" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/RasterizationAndRayTracing.jpeg" alt="RasterizationAndRayTracing" caption="RasterizationAndRayTracing" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/At&tPixelMachine.jpeg" alt="At&tPixelMachine" caption="At&tPixelMachine" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/PascalAndTuring.jpeg" alt="PascalAndTuring" caption="PascalAndTuring" %}

전통적인 GPU(파스칼 포함)에서는 래스터화를 위한 특화된 작업을 했다면, 튜링부터는 인공지능과 광선 추적법을 위한 특화된 작업을 해주는 코어가 추가되었다. 이 코어가 각각 텐서 코어와 RT 코어이다.

## RT 코어

{% include image.html src="/assets/images/RayTracingEssentials/BVH.jpeg" alt="BVH" caption="BVH" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/GpuMemory.jpeg" alt="GpuMemory" caption="GpuMemory" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/MetroExodusOneFrame.jpeg" alt="MetroExodusOneFrame" caption="MetroExodusOneFrame" %}

기존 아키텍처에서 광선 추적법을 했을 때 걸린 시간, 현재 아키텍처에서 RT 코어를 사용하지 않고 광선 추적법을 했을 때의 걸린 시간, RT 코어를 사용했을 때 걸린 시간 등을 보여주는 사진이다.

{% include image.html src="/assets/images/RayTracingEssentials/BattlefieldV.jpeg" alt="BattlefieldV" caption="BattlefieldV" %}

광선 추적법에 특화된 하드웨어가 중요할 뿐만 아니라, 해당 하드웨어, 소프트웨어를 앞으로 튜닝해가면 더욱 더 빨라지기 시작할 것이다.

{% include image.html src="/assets/images/RayTracingEssentials/NVIDIARealTimeRayTracing.jpeg" alt="NVIDIARealTimeRayTracing" caption="NVIDIARealTimeRayTracing" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/RasterizationAndRayTracingPipeline.jpeg" alt="RasterizationAndRayTracingPipeline" caption="RasterizationAndRayTracingPipeline" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/RTXRayTracingPipeline.jpeg" alt="RTXRayTracingPipeline" caption="RTXRayTracingPipeline" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/ShadersComplicated.jpeg" alt="ShadersComplicated" caption="ShadersComplicated" %}

위의 셰이더를 총합하면 위와 같이 복잡하게 되어있는데, 이걸 단순화해줄 수 있다.

{% include image.html src="/assets/images/RayTracingEssentials/ShadersSimplified.jpeg" alt="ShadersSimplified" caption="ShadersSimplified" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/AnyHitShader.jpeg" alt="AnyHitShader" caption="AnyHitShader" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/CornellBox.jpeg" alt="CornellBox" caption="CornellBox" %}

왼쪽이 실제 사진, 오른쪽이 광선 추적법으로 렌더링한 사진.

{% include image.html src="/assets/images/RayTracingEssentials/HardShadows.jpeg" alt="HardShadows" caption="HardShadows" %}

우선 영역광 말고, 단순한 점광부터 적용해본다. 이러면 매우 날카로운 그림자가 질 것이다.

{% include image.html src="/assets/images/RayTracingEssentials/SoftShadows.jpeg" alt="SoftShadows" caption="SoftShadows" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/GlobalIllumination.jpeg" alt="GlobalIllumination" caption="GlobalIllumination" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/GlossyReflection.jpeg" alt="GlossyReflection" caption="GlossyReflection" %}

광택이 있는 표면의 경우 여러 개의 반사광이 생길 수 있다.

{% include image.html src="/assets/images/RayTracingEssentials/GlossinessComparison.jpeg" alt="GlossinessComparison" caption="GlossinessComparison" %}

광택의 정도는 조절이 가능하다.

{% include image.html src="/assets/images/RayTracingEssentials/ExampleScene.jpeg" alt="ExampleScene" caption="ExampleScene" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/AmbientOcclusionNoLight.jpeg" alt="AmbientOcclusionNoLight" caption="AmbientOcclusionNoLight" %}

위 그림에서는 딱히 광원이 아무것도 없는 상태이다. 이때 모든 지점에서 광선을 쏘아 이 지점이 틈 사이에 있는지, 가려져있는지 등을 확인해줄 수 있다.

{% include image.html src="/assets/images/RayTracingEssentials/AmbientOcclusion.jpeg" alt="AmbientOcclusion" caption="AmbientOcclusion" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/DoFBackgroundBlur.jpeg" alt="DoFBackgroundBlur" caption="DoFBackgroundBlur" %}

이뿐만 아니라 광선 추적법을 통해 심도 표현과 블러 효과를 줄 수 있다.

{% include image.html src="/assets/images/RayTracingEssentials/DoFForgroundBlur.jpeg" alt="DoFForgroundBlur" caption="DoFForgroundBlur" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/MotionBlur.jpeg" alt="MotionBlur" caption="MotionBlur" %}

샘플링을 할 때, 아예 한 픽셀 당 여러 시간에 대응하는 모델의 모습을 주고, 이를 통해 광선 추적법을 적용하면 *모션 블러Motion Blur* 효과를 얻을 수 있다.

## 대기 효과

{% include image.html src="/assets/images/RayTracingEssentials/AtmosphericEffects.jpeg" alt="AtmosphericEffects" caption="AtmosphericEffects" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/Caustics.jpeg" alt="Caustics" caption="Caustics" %}

*가성caustic*이란 물과 관련된 빛의 성질로, 위의 그림처럼 물과 같이 투명한 물질에 빛이 닿아 반사될 때의 모습이다.

{% include image.html src="/assets/images/RayTracingEssentials/CausticsOnTheGround.jpeg" alt="CausticsOnTheGround" caption="CausticsOnTheGround" %}

위의 사진처럼 바닥 위에 가성이 형성된 모습이다.

{% include image.html src="/assets/images/RayTracingEssentials/CausticsPBR.jpeg" alt="CausticsPBR" caption="CausticsPBR" %}

# 6부: 렌더링 방정식

렌더링 방정식이라는게 렌더링하는 여러 방정식이라는 뜻이 아니다. 이름 자체가 렌더링 방정식이라는 어떤 한 방정식이 존재한다는 뜻이다.

{% include image.html src="/assets/images/RayTracingEssentials/TheRenderingEquation.gif" alt="TheRenderingEquation" caption="TheRenderingEquation" %}

공식만 보고 겁 먹고 공부를 그만두지는 말도록 하자. 그래픽스 전공을 할 사람들이 살면서 이 방정식 하나만 갖고 결국 다 다루기 때문에 겁 먹지 말고 하나 하나 보도록 하자.

## 렌더링 방정식

{% include image.html src="/assets/images/RayTracingEssentials/TheRenderingEquationExplained.jpeg" alt="TheRenderingEquationExplained" caption="TheRenderingEquationExplained" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/TheRenderingEquationByElement.jpeg" alt="TheRenderingEquationByElement" caption="TheRenderingEquationByElement" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/PurePathTracing.jpeg" alt="PurePathTracing" caption="PurePathTracing" %}

즉, 순수한 경로 추적을 하게 되면, 모든 방향으로의 빛을 전부 더해주어 눈에 쏴주는 것이다.

{% include image.html src="/assets/images/RayTracingEssentials/PurePathTracingExample.jpeg" alt="PurePathTracingExample" caption="PurePathTracingExample" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/MirrorGlossyDiffuse.jpeg" alt="MirrorGlossyDiffuse" caption="MirrorGlossyDiffuse" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/MultipleImportanceSampling.jpeg" alt="MultipleImportanceSampling" caption="MultipleImportanceSampling" %}

위의 사진처럼 광원 쪽으로도 광선을 쏘게 된다.

{% include image.html src="/assets/images/RayTracingEssentials/MISComparison.jpeg" alt="MISComparison" caption="MISComparison" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/NoiseInRayTracing.jpeg" alt="NoiseInRayTracing" caption="NoiseInRayTracing" %}

광선 추적법을 사용하면 위와 같이 매우 노이즈가 심한 사진을 얻게 된다. 이는 픽셀 당 샘플링의 수를 늘리는 것으로 해결할 수 있긴 하다.

{% include image.html src="/assets/images/RayTracingEssentials/Denoising.jpeg" alt="Denoising" caption="Denoising" %}

위와 같이 디노이징 기법을 사용하면 충분히 노이즈를 지울 수 있는 장점이 있다. 분산이 샘플 수의 제곱근에 비례해서 줄어들으므로, 샘플을 하나 쓰는 것보다 네 개를 쓰는 것이 두 배나 더 좋을 것이다.

{% include image.html src="/assets/images/RayTracingEssentials/RayTracingDenoising.jpeg" alt="RayTracingDenoising" caption="RayTracingDenoising" %}

결과적으로 노이즈가 있는 사진을 우선 얻은 뒤, 이걸 더 나은 사진으로 만들어 주어야 한다.

{% include image.html src="/assets/images/RayTracingEssentials/Reconstruct.jpeg" alt="Reconstruct" caption="Reconstruct" %}

이러한 과정을 바로 디노이징이라 부른다.

{% include image.html src="/assets/images/RayTracingEssentials/DenoisingIdenticalTime.jpeg" alt="DenoisingIdenticalTime" caption="DenoisingIdenticalTime" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/DenoisingShadow.jpeg" alt="DenoisingShadow" caption="DenoisingShadow" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/DenoisingHumanVsNeuralNetwork.jpeg" alt="DenoisingHumanVsNeuralNetwork" caption="DenoisingHumanVsNeuralNetwork" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/DenoisingTraining.jpeg" alt="DenoisingTraining" caption="DenoisingTraining" %}

심화학습을 사용하여 디노이징을 해줄 수도 있다. 렌더링된 이미지 여러 개를 바탕으로 훈련시켜 디노이징을 구현하는 것이다.

{% include image.html src="/assets/images/RayTracingEssentials/NoisyImage.jpeg" alt="NoisyImage" caption="NoisyImage" %}

위와 같이 픽셀 당 샘플링(spp)이 1인 사진이 주어졌을 때, 디노이징을 적용하면 다음과 같아진다:

{% include image.html src="/assets/images/RayTracingEssentials/DenoisedImage.jpeg" alt="DenoisedImage" caption="DenoisedImage" %}

상당히 현실적인 이미지가 나왔다.

{% include image.html src="/assets/images/RayTracingEssentials/GroundTruthImage.jpeg" alt="GroundTruthImage" caption="GroundTruthImage" %}

광선 추적법으로 제대로 렌더링한 이미지와 비교해도 상당히 유사함을 알 수 있다.

{% include image.html src="/assets/images/RayTracingEssentials/LightMappingImage.jpeg" alt="LightMappingImage" caption="LightMappingImage" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/NoisyGlossyImage.jpeg" alt="NoisyGlossyImage" caption="NoisyGlossyImage" %}

이번엔 광택이 있는 이미지들이다.

{% include image.html src="/assets/images/RayTracingEssentials/DenoisedGlossyImage.jpeg" alt="DenoisedGlossyImage" caption="DenoisedGlossyImage" %}

디노이징 기법만 적용을 해줘도 상당히 훌륭한 사진이 나온다.

{% include image.html src="/assets/images/RayTracingEssentials/GroundTruthGlossyImage.jpeg" alt="GroundTruthGlossyImage" caption="GroundTruthGlossyImage" %}

이번엔 디노이징을 준 이미지와 실제 이미지와 약간 차이는 있으나, 그래도 대부분의 사람들에게는 충분히 납득할만한 결과가 나왔다고 볼 수 있다.

{% include image.html src="/assets/images/RayTracingEssentials/StochasticScreenSpaceReflection.jpeg" alt="StochasticScreenSpaceReflection" caption="StochasticScreenSpaceReflection" %}

위의 사진의 경우 보통 래스터화 기법에서 사용하는 방법인데, 여러 문제가 있다. 물론 잘 되는 경우도 있지만, 잘 안되는 경우도 있다.

{% include image.html src="/assets/images/RayTracingEssentials/NoisyGlobalIllumination.jpeg" alt="NoisyGlobalIllumination" caption="NoisyGlobalIllumination" %}

이번 예시의 경우 전역 조명을 적용했을 때이다.

{% include image.html src="/assets/images/RayTracingEssentials/DenoisedGlobalIllumination.jpeg" alt="DenoisedGlobalIllumination" caption="DenoisedGlobalIllumination" %}

마찬가지로 디노이징을 해주자 결과가 상당히 훌륭하게 나온다.

{% include image.html src="/assets/images/RayTracingEssentials/GroundTruthGlobalIllumination.jpeg" alt="GroundTruthGlobalIllumination" caption="GroundTruthGlobalIllumination" %}
...
{% include image.html src="/assets/images/RayTracingEssentials/AreaLightSpecularShadingWithOcclusion.jpeg" alt="AreaLightSpecularShadingWithOcclusion" caption="AreaLightSpecularShadingWithOcclusion" %}
