...
{% include image.html src="/assets/images/RestirForGameGi/RenderingEquation.png" alt="RenderingEquation" caption="RenderingEquation" %}
...
{% include image.html src="/assets/images/RestirForGameGi/ImportanceSamplingFx.png" alt="ImportanceSamplingFx" caption="ImportanceSamplingFx" %}

{% include image.html src="/assets/images/RestirForGameGi/ImportanceSamplingL.png" alt="ImportanceSamplingL" caption="ImportanceSamplingL" %}

이걸 몬테 카를로 Importance Sampling(IS)를 통해 source 확률밀도함수 p(x<sub>i</sub>)에서 N 개의 샘플 x<sub>i</sub> 고르면 적분식을 estimate 할 수 있게 됨:

{% include image.html src="/assets/images/RestirForGameGi/ImportanceSamplingMonteCarloIntegration.png" alt="ImportanceSamplingMonteCarloIntegration" caption="ImportanceSamplingMonteCarloIntegration" %}
...
{% include image.html src="/assets/images/RestirForGameGi/MultipleImportanceSamplingMonteCarloIntegration.png" alt="MultipleImportanceSamplingMonteCarloIntegration" caption="MultipleImportanceSamplingMonteCarloIntegration" %}

이때 가중치 w<sub>s</sub> 들의 합이 1만 이루기만 하면 MIS는 무편향성을 가짐. 대표적인 가중치 함수로는 balance heuristic 함수를 쓺:

{% include image.html src="/assets/images/RestirForGameGi/MultipleImportanceSamplingBalanceHeuristic.png" alt="MultipleImportanceSamplingBalanceHeuristic" caption="MultipleImportanceSamplingBalanceHeuristic" %}
...
{% include image.html src="/assets/images/RestirForGameGi/ResampledImportanceSamplingOptimalSourcePdf.png" alt="ResampledImportanceSamplingOptimalSourcePdf" caption="ResampledImportanceSamplingOptimalSourcePdf" %}
...
{% include image.html src="/assets/images/RestirForGameGi/ResampledImportanceSamplingNormalizationApproximation.png" alt="ResampledImportanceSamplingNormalizationApproximation" caption="ResampledImportanceSamplingNormalizationApproximation" %}
...
{% include image.html src="/assets/images/RestirForGameGi/ResampledImportanceSamplingMonteCarloIntegration.png" alt="ResampledImportanceSamplingMonteCarloIntegration" caption="ResampledImportanceSamplingMonteCarloIntegration" %}

여기서 N 개의 샘플이 아니라, 하나의 샘플만을 다루게 된다면 식을 다음과 같이 정리할 수 있다:

{% include image.html src="/assets/images/RestirForGameGi/ResampledImportanceSamplingSingleSampleMonteCarloIntegration.png" alt="ResampledImportanceSamplingSingleSampleMonteCarloIntegration" caption="ResampledImportanceSamplingSingleSampleMonteCarloIntegration" %}
