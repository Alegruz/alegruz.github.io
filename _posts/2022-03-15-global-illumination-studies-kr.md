...
categories: graphics
lang: "ko"
description: "이 노트는 Real-Time Rendering 책 등을 읽고 한국어로 정리한 책입니다."
status: "notes"
difficulty: "advanced"
topic: rendering
tags: [rendering]
...
{% include image.html src="/assets/images/GlobalIllumination/ReflectanceEquation.svg" alt="ReflectanceEquation" caption="ReflectanceEquation" %}

{% include image.html src="/assets/images/GlobalIllumination/ReflectanceEquationImage.png" alt="ReflectanceEquationImage" caption="ReflectanceEquationImage" %}

### 렌더링 방정식

사실 반사 방정식은 렌더링 방정식의 한 특수한 경우임.

{% include image.html src="/assets/images/GlobalIllumination/RenderingEquation.png" alt="RenderingEquation" caption="RenderingEquation" %}

여기서 ![EmittedRadiance](/assets/images/GlobalIllumination/EmittedRadiance.png)은 표면 위의 한 점 **p**에서 **v** 방향으로 발광하는 방사 휘도를 의미함.

{% include image.html src="/assets/images/GlobalIllumination/IncomingRadianceIsOutgoingRadiance.png" alt="IncomingRadianceIsOutgoingRadiance" caption="IncomingRadianceIsOutgoingRadiance" %}
...
{% include image.html src="/assets/images/GlobalIllumination/Radiosity.png" alt="Radiosity" caption="Radiosity" %}
...
{% include image.html src="/assets/images/GlobalIllumination/FormFactor.png" alt="FormFactor" caption="FormFactor" %}
...
{% include image.html src="/assets/images/GlobalIllumination/AOIrradiance.png" alt="AOIrradiance" caption="AOIrradiance" %}
