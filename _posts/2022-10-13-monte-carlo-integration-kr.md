...
categories: math
lang: "ko"
description: "몬테 카를로 적분법Monte Carlo integration이란 적분값을 직접 구하기 힘들 때, 무작위로 sample을 추출하여 적분값을 추정하는 방법임."
status: "notes"
difficulty: "advanced"
series: "math-notes"
series_order: 1
...
{% include image.html src="/assets/images/MonteCarloIntegration/ProbabilityOfASingleLight.png" alt="ProbabilityOfASingleLight" caption="ProbabilityOfASingleLight" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/Integral.png" alt="Integral" caption="Integral" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/SingleNorm.png" alt="SingleNorm" caption="SingleNorm" %}

이 된다.

이걸 전부 더해주면 우리는 적분값을 추정할 수 있게 될 것이다:

{% include image.html src="/assets/images/MonteCarloIntegration/RiemannSum.png" alt="RiemannSum" caption="RiemannSum" %}

이때 이 값의 기대값은 과연 얼마일까?

{% include image.html src="/assets/images/MonteCarloIntegration/RiemannSumExpectedValue.png" alt="RiemannSumExpectedValue" caption="RiemannSumExpectedValue" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/MonteCarloEstimator.png" alt="MonteCarloEstimator" caption="MonteCarloEstimator" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/MultipleVariablesIntegral.png" alt="MultipleVariablesIntegral" caption="MultipleVariablesIntegral" %}

이 경우 확률 변수 X<sub>i</sub> = (x<sub>i</sub>, y<sub>i</sub>, z<sub>i</sub>)가 주어진 범위에서 연속 균등하게 분포되어있다면,

{% include image.html src="/assets/images/MonteCarloIntegration/MultipleVariablesUniformMonteCarloEstimator.png" alt="MultipleVariablesUniformMonteCarloEstimator" caption="MultipleVariablesUniformMonteCarloEstimator" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/InversionMethodExamplePdf.png" alt="InversionMethodExamplePdf" caption="InversionMethodExamplePdf" %}

이 분포로부터 한 표본을 뽑으려면 우선 CDF P(x)를 구해야한다.

{% include image.html src="/assets/images/MonteCarloIntegration/InversionMethodExampleCdf.png" alt="InversionMethodExampleCdf" caption="InversionMethodExampleCdf" %}

이제 간단하다. CDF P(x)의 결과값, 즉 치역인 [0, 1] 사이에서 연속 균등 확률 변수 값 ξ 하나를 뽑으면 된다.

{% include image.html src="/assets/images/MonteCarloIntegration/InversionMethodExample.png" alt="InversionMethodExample" caption="InversionMethodExample" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/RejetionMethodExample.png" alt="RejetionMethodExample" caption="RejetionMethodExample" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/TransformingBetweenDistributionsXYPdfs.png" alt="TransformingBetweenDistributionsXYPdfs" caption="TransformingBetweenDistributionsXYPdfs" %}

즉,

{% include image.html src="/assets/images/MonteCarloIntegration/TransformingBetweenDistributionsXYPdfsPostive.png" alt="TransformingBetweenDistributionsXYPdfsPostive" caption="TransformingBetweenDistributionsXYPdfsPostive" %}

이걸 이제 일반화해주자. y가 단조감소인 경우까지 고려해주면 절대값을 씌워주면 될 것이다:

{% include image.html src="/assets/images/MonteCarloIntegration/TransformingBetweenDistributionsXYPdfsGeneralized.png" alt="TransformingBetweenDistributionsXYPdfsGeneralized" caption="TransformingBetweenDistributionsXYPdfsGeneralized" %}

예를 들어 정의역 [0, 1]에 대해 p<sub>x</sub>(x) = 2x이고, Y = sin x라고 가정하면, 확률 변수 Y에 대한 PDF는:

{% include image.html src="/assets/images/MonteCarloIntegration/TransformingBetweenDistributionsExample.png" alt="TransformingBetweenDistributionsExample" caption="TransformingBetweenDistributionsExample" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/TransformingBetweenDistributionsMultipleDimensionsPdf.png" alt="TransformingBetweenDistributionsMultipleDimensionsPdf" caption="TransformingBetweenDistributionsMultipleDimensionsPdf" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/TransformingBetweenDistributionsPolarCoordinates.png" alt="TransformingBetweenDistributionsPolarCoordinates" caption="TransformingBetweenDistributionsPolarCoordinates" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/MarginalDensityFunction.png" alt="MarginalDensityFunction" caption="MarginalDensityFunction" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/ConditionalDensityFunction.png" alt="ConditionalDensityFunction" caption="ConditionalDensityFunction" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/ThetaMarginalDensityFunction.png" alt="ThetaMarginalDensityFunction" caption="ThetaMarginalDensityFunction" %}

이제 &phi;에 대한 조건부 확률을 구해보도록 하자:

{% include image.html src="/assets/images/MonteCarloIntegration/PhiConditionalDensityFunction.png" alt="PhiConditionalDensityFunction" caption="PhiConditionalDensityFunction" %}

어라? &phi;는 보니까 균등 확률을 갖고 있다. 직관적으로 이해해보자면, 이러면 반구의 대칭성이 설명이 된다. 자 이제 일차원 기법으로 각 PDF를 순서대로 표집해보자.

{% include image.html src="/assets/images/MonteCarloIntegration/2dSamplingExampleCdfs.png" alt="2dSamplingExampleCdfs" caption="2dSamplingExampleCdfs" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/2dSamplingToCartesianCoordinates.png" alt="2dSamplingToCartesianCoordinates" caption="2dSamplingToCartesianCoordinates" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/UnitDiskRTheta.png" alt="UnitDiskRTheta" caption="UnitDiskRTheta" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/CosineWeightedHemisphereC.png" alt="CosineWeightedHemisphereC" caption="CosineWeightedHemisphereC" %}

즉,

{% include image.html src="/assets/images/MonteCarloIntegration/CosineWeightedHemisphereSphericalCoordinatesPdf.png" alt="CosineWeightedHemisphereSphericalCoordinatesPdf" caption="CosineWeightedHemisphereSphericalCoordinatesPdf" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/MultipleImportanceSamplingMonteCarloEstimatorExample.png" alt="MultipleImportanceSamplingMonteCarloEstimatorExample" caption="MultipleImportanceSamplingMonteCarloEstimatorExample" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/BalanceHeuristic.png" alt="BalanceHeuristic" caption="BalanceHeuristic" %}

실무에서는 보통 **제곱 휴리스틱power heuristic**을 사용하여 더욱 분산을 줄이곤 한다. 지수 &beta;에 대하여 표현한다:

{% include image.html src="/assets/images/MonteCarloIntegration/PowerHeuristic.png" alt="PowerHeuristic" caption="PowerHeuristic" %}
...
{% include image.html src="/assets/images/MonteCarloIntegration/Experiment00.png" alt="Experiment00" caption="Experiment00" %}
